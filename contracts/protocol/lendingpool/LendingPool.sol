...
contract LendingPool is VersionedInitializable, ILendingPool, LendingPoolStorage {
  ...
  function setLiquidationWhitelist(
    address liquidator,
    bool allowed
  ) external override onlyLendingPoolConfigurator {
    _liquidationWhitelist[liquidator] = allowed;
    emit LiquidationWhitelistUpdated(liquidator, allowed);
  }

  function isLiquidationWhitelisted(address liquidator) external view override returns (bool) {
    return _liquidationWhitelist[liquidator];
  }
